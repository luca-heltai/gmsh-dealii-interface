...
namespace Step40
{
  ...
  void LaplaceProblem<dim>::output_results() const
  {
    ...
    const std::string filename = "solution-" + Utilities::int_to_string(Utilities::MPI::this_mpi_process(mpi_communicator), 4) + ".vtu";
