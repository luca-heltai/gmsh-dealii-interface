...
auto main() -> int
{
  ...
  std::string merged_mesh_file = SOURCE_DIR "/../grids/new_meshes/test_grid_2_merged.msh";
  ...
  deallog << "Number of cells in merged mesh: " << merged_triangulation.n_active_cells() << std::endl;
  deallog << "Number of vertices in merged mesh: " << merged_triangulation.n_vertices() << std::endl;
