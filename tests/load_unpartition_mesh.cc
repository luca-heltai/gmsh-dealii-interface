...
int main(int argc, char **argv)
{
   ...
   // dealii::Triangulation<2, 2> triangulation;
    ...
    std::string output_file = SOURCE_DIR "/../grids/new_meshes/test_grid_2_merged.msh";
    ...
    std::ifstream input_file(SOURCE_DIR "/../grids/new_meshes/test_grid_2_merged.msh");
...
std::cout << "DEAL::Number of cells: " << triangulation.n_active_cells() << std::endl;
